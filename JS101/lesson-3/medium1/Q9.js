...
Problem is asking for what the console will log after the function is run
*/
...
from my understanding i think the answer will come out to paper after all the functions run
*/
